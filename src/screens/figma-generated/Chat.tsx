              ...
              <View style={[styles.avatar, styles.avatarBorder]}>
                <ImageBackground style={styles.imageIcon} resizeMode="cover" source="Image.png">
                  <View style={styles.row}>
                    ...
                    <View style={[styles.chatScaleUnit, styles.chatsPosition]}>
        ...
        <View style={[styles.chats, styles.chatsPosition]}>
          <View style={[styles.matchCard, styles.avatarBorder]}>
            ...
            <Text style={[styles.text5, styles.textTypo]}>
              ...
              <Text style={styles.hi}>, please help her review that candidate AI developing skills.</Text>
            </Text>
          </View>
          <View style={[styles.matchCard, styles.avatarBorder]}>
            <View style={styles.textParent}>
            ...
            <Text style={[styles.text9, styles.textTypo]}>Conduct a rapid assessment of structural integrity in Sector</Text>
          </View>
          <View style={[styles.matchCard, styles.avatarBorder]}>
            <View style={styles.textParent}>
