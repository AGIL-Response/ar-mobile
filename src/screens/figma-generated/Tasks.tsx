...
import { Color, FontFamily, Gap, Padding, Border, FontSize } from "../GlobalStyles";
    ...
    <SafeAreaView style={styles.tasks}>
      <View style={styles.view}>
        <View style={[styles.tasks2, styles.tasksPosition]}>
          <View style={styles.content}>
            <View style={styles.commander}>
              <Text style={[styles.headline, styles.textTypo2]}>Pending Tasks (4)</Text>
              <View style={styles.matchCard}>
                <View style={[styles.section, styles.sectionFlexBox]}>
                  ...
                  <Text style={[styles.text, styles.textTypo2]}>Assess Structural Damage</Text>
                  <View style={[styles.badge, styles.badgeSpaceBlock]}>
                    <Text style={[styles.tasksText, styles.textTypo1]}>In Progress</Text>
                  </View>
                </View>
                <Text style={[styles.text2, styles.textTypo]}>Conduct a rapid assessment of structural integrity in Sector</Text>
                <Text style={[styles.text3, styles.textTypo]}>Today, 2:00 PM</Text>
              </View>
              <View style={styles.matchCard}>
                <View style={[styles.section, styles.sectionFlexBox]}>
                  <View style={styles.checkboxDarkMode}>
                  ...
                  <Text style={[styles.text, styles.textTypo2]}>Evacuate Sector Delta</Text>
                  <View style={[styles.tasksBadge, styles.badgeSpaceBlock]}>
                    <Text style={[styles.text5, styles.textTypo1]}>Not Started</Text>
                  </View>
                </View>
                <Text style={[styles.text2, styles.textTypo]}>Ensure all civilians are safely evacuated from Sector Delta</Text>
                <View style={styles.textWrapper}>
                  <Text style={[styles.text3, styles.textTypo]}>Tomorrow, 9:30 PM</Text>
                </View>
              </View>
              <View style={styles.matchCard}>
                <View style={[styles.section, styles.sectionFlexBox]}>
                  ...
                  <View style={styles.badge2}>
                    <Text style={[styles.tasksText, styles.textTypo1]}>Overdue</Text>
                  </View>
                </View>
                <Text style={[styles.text2, styles.textTypo]}>Establish a secure perimeter around the incident site in</Text>
                <Text style={[styles.text3, styles.textTypo]}>Mon, 9:00 AM</Text>
              </View>
            </View>
          </View>
          <View style={styles.content}>
            <View style={styles.commander}>
              <Text style={[styles.headline, styles.textTypo2]}>Completed Tasks (2)</Text>
              <View style={styles.matchCard}>
                <View style={[styles.section, styles.sectionFlexBox]}>
                  <View style={styles.checkboxDarkMode}>
                    <View style={[styles.checkbox, styles.iconLayout1]} />
                  </View>
                  <Text style={[styles.text, styles.textTypo2]}>Provide medical aid</Text>
                  <View style={[styles.badge3, styles.badgeSpaceBlock]}>
                    <Text style={[styles.tasksText, styles.textTypo1]}>Completed</Text>
                  </View>
                </View>
                <Text style={[styles.text2, styles.textTypo]}>Administer first aid to injured personnel at the triage point in</Text>
                <Text style={[styles.text3, styles.textTypo]}>Yesterday, 11:00 AM</Text>
              </View>
              <View style={styles.matchCard}>
                <View style={[styles.section, styles.sectionFlexBox]}>
                  <View style={styles.checkboxDarkMode}>
                  ...
                  <Text style={[styles.text, styles.textTypo2]}>Replenish supplies</Text>
                  <View style={[styles.badge3, styles.badgeSpaceBlock]}>
                    <Text style={[styles.tasksText, styles.textTypo1]}>Completed</Text>
                  </View>
                </View>
                <Text style={[styles.text2, styles.textTypo]}>Restock medical and communication supplies at</Text>
                <Text style={[styles.text3, styles.textTypo]}>Yesterday, 3:00 PM</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={[styles.navigateBar, styles.tabLayout]}>
          ...
          <View style={styles.navigateLayout}>
            <List1 style={[styles.listIcon, styles.iconLayout1]} width={24} height={24} />
          ...
          <View style={styles.navigateLayout}>
            <Messagechatcircle style={[styles.listIcon, styles.iconLayout1]} width={24} height={24} />
        ...
        <View style={styles.appBar}>
          ...
          <View style={[styles.trailingElements, styles.sectionFlexBox]}>
            ...
            <View style={[styles.userAvatar, styles.avatarFlexBox]}>
              <Image style={styles.searchMdIcon} resizeMode="cover" source="Icon Badge/Normal.png" />
            </View>
              ...
              <View style={[styles.avatar, styles.avatarBorder]}>
                <ImageBackground style={styles.imageIcon} resizeMode="cover" source="Image.png">
                  <View style={styles.row}>
                    ...
                    <View style={[styles.tasksScaleUnit, styles.tasksPosition]}>
        ...
        <View style={[styles.tab, styles.tabLayout]}>
          ...
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.tasksPersonalDetails, styles.tasksTypo]}>Pending</Text>
            <View style={styles.shapeFlexBox} />
          </View>
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.tasksPersonalDetails, styles.tasksTypo]}>Completed</Text>
            <View style={styles.shapeFlexBox} />
          </View>
        </View>
      </View>
