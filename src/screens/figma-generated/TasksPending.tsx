...
import { Color, FontFamily, Padding, Border, FontSize, Gap } from "../GlobalStyles";
    ...
    <SafeAreaView style={styles.tasks}>
      <View style={styles.view}>
        ...
        <View style={[styles.statusBariphone12Mini, styles.scalePosition]}>
          ...
          <Text style={[styles.time, styles.tasksTypo]}>9:41</Text>
        </View>
        <View style={styles.navigateBar}>
          ...
          <View style={styles.navigateLayout}>
            ...
            <Text style={[styles.tasks2, styles.homeTypo]}>Tasks</Text>
            <View style={[styles.bagde, styles.bagdePosition]}>
              <Text style={[styles.text12, styles.tasksTypo]}>1</Text>
            </View>
          </View>
          <View style={styles.navigateLayout}>
        ...
        <View style={[styles.appBar, styles.appBarFlexBox]}>
          <View style={styles.textContent}>
            <Text style={[styles.tasksHeadline, styles.tasksTypo]}>Tasks</Text>
              ...
              <View style={[styles.avatar, styles.avatarBorder]}>
                <ImageBackground style={styles.imageIcon} resizeMode="cover" source="Image.png">
                  <View style={styles.row}>
                    ...
                    <View style={[styles.tasksScaleUnit, styles.scalePosition]}>
        ...
        <View style={[styles.button, styles.appBarFlexBox]}>
          <Image style={styles.buttonChild} resizeMode="cover" source="Frame 7.png" />
        </View>
        <View style={styles.tab}>
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.personalDetails, styles.homeTypo]}>All</Text>
            <View style={[styles.shapeSharp, styles.shapeFlexBox]} />
          </View>
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.tasksPersonalDetails, styles.tasksTypo]}>Pending</Text>
            <View style={[styles.tasksShapeSharp, styles.shapeFlexBox]} />
          </View>
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.personalDetails, styles.homeTypo]}>Completed</Text>
            <View style={[styles.shapeSharp2, styles.shapeFlexBox]} />
          </View>
        </View>
      </View>
    </SafeAreaView>);
