...
import { Color, FontFamily, Border, Gap, FontSize, Padding } from "../GlobalStyles";
    ...
    <SafeAreaView style={styles.homescreen}>
      <View style={styles.view}>
        ...
        <View style={styles.navigateBar}>
          ...
          <View style={styles.navigateLayout}>
            <List1 style={[styles.listIcon, styles.iconLayout]} width={24} height={24} />
          ...
          <View style={styles.navigateLayout}>
            <Messagechatcircle style={[styles.listIcon, styles.iconLayout]} width={24} height={24} />
        ...
        <View style={[styles.appBar, styles.appBarFlexBox]}>
          <View style={styles.textContent}>
            <Text style={[styles.headline, styles.textTypo]}>Alpha-7 Task Force</Text>
        ...
        <View style={styles.tab}>
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.personalDetails, styles.personalTypo]}>Flat View</Text>
            <View style={[styles.shapeSharp, styles.shapeFlexBox]} />
          </View>
          <View style={styles.tabHorizontalItemDark}>
            <Text style={[styles.homescreenPersonalDetails, styles.personalTypo]}>Map View</Text>
        ...
        <View style={[styles.alert, styles.alertLayout1]}>
          <Ellipse1 style={[styles.alertChild, styles.alertLayout1]} width={48} height={48} />
        ...
        <View style={[styles.homescreenAlert, styles.alertLayout]}>
          <Ellipse11 style={[styles.alertItem, styles.alertLayout]} width={64} height={64} />
        ...
        <View style={[styles.alert2, styles.alertLayout]}>
          <Ellipse12 style={[styles.alertItem, styles.alertLayout]} width={64} height={64} />
        ...
        <View style={[styles.alert3, styles.alertLayout]}>
          <Ellipse13 style={[styles.alertItem, styles.alertLayout]} width={64} height={64} />
        ...
        <View style={[styles.alert4, styles.alertLayout1]}>
          <Ellipse14 style={[styles.alertChild, styles.alertLayout1]} width={48} height={48} />
          <View style={[styles.homescreenButton, styles.homescreenPosition]}>
            <Frame72 style={styles.buttonItem} width={16} height={32} />
          </View>
        </View>
        <View style={[styles.alert5, styles.alertLayout1]}>
          <Ellipse15 style={[styles.alertChild, styles.alertLayout1]} width={48} height={48} />
          <View style={[styles.homescreenButton, styles.homescreenPosition]}>
            <Frame73 style={styles.buttonItem} width={16} height={32} />
          </View>
        </View>
        <View style={[styles.alert6, styles.alertLayout1]}>
          <Ellipse16 style={[styles.alertChild, styles.alertLayout1]} width={48} height={48} />
          <View style={[styles.homescreenButton, styles.homescreenPosition]}>
            <Frame74 style={styles.buttonItem} width={16} height={32} />
          </View>
        </View>
        <Frame29 style={[styles.child, styles.childLayout]} width={30} height={30} />
        <Frame30 style={[styles.item, styles.childLayout]} width={30} height={30} />
        <Frame31 style={[styles.inner, styles.childLayout]} width={30} height={30} />
        <Frame32 style={[styles.homescreenChild, styles.childLayout]} width={30} height={30} />
      </View>
    </SafeAreaView>);
};
