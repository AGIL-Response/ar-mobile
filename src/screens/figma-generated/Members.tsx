      ...
      <View style={styles.view}>
        ...
        <View style={styles.content}>
          <View style={styles.commander}>
            <Text style={[styles.homescreenHeadline, styles.headlineFlexBox]}>
              Commander
            </Text>
            <View style={[styles.cardCardItemDark, styles.cardItemBorder]}>
              <View style={[styles.frameParent, styles.frameFlexBox]}>
                <View
                  style={[styles.avatarStatusParent, styles.avatarCardFlexBox]}
                >
                  <View style={[styles.avatarStatus, styles.avatarCardFlexBox]}>
                    <View style={[styles.avatar, styles.avatarLayout]}>
                      ...
                      >
                        <View style={styles.row}>
                          ...
                          <View
                            style={[
                              styles.homescreenScaleUnit,
                              styles.scalePosition,
                            ]}
                          />
                        </View>
                        <View style={styles.row}>
                    ...
                    <View
                      style={[styles.indicator, styles.indicatorPosition]}
                    />
                  </View>
                  <View style={styles.imageIcon}>
                    <Text style={[styles.johnDoe, styles.headlineFlexBox]}>
                      John Doe
                    </Text>
                  </View>
                </View>
          ...
          <View style={styles.commander}>
            <Text style={[styles.headline2, styles.headlineFlexBox]}>
              Members
            </Text>
            <View
              style={[styles.homescreenCardCardItemDark, styles.cardItemBorder]}
            >
              ...
              <View style={[styles.frameGroup, styles.frameFlexBox]}>
                ...
                >
                  <View style={[styles.avatarStatus, styles.avatarCardFlexBox]}>
                    ...
                    <View
                      style={[styles.indicator2, styles.indicatorPosition]}
                    />
                  </View>
                  <View style={styles.imageIcon}>
                    <Text style={[styles.johnDoe, styles.headlineFlexBox]}>
