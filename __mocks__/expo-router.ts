...
const StackScreenMock = ({ children }: any) => {
  const React = require('react');
  return React.createElement(React.Fragment, null, children);
};
StackScreenMock.displayName = 'StackMock.Screen';
...
const TabsScreenMock = ({ children }: any) => {
  const React = require('react');
  return React.createElement(React.Fragment, null, children);
};
TabsScreenMock.displayName = 'TabsMock.Screen';
